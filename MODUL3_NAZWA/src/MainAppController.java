...
public class MainAppController {
    ...
    private void deleteTask() {
        try {
            ...
            if (selected == null) {
                ...
                throw new TaskNotSelectedException("Pesan tidak terdeteksi tepilih");
    ...
    private void markTaskComplete() {
        try {
            ...
            if (selected == null) {
                // TODO: Throw new TaskNotSelectedException dengan pesan yang sesuai 
                throw new TaskNotSelectedException("Pesan tidak terdeteksi terpilih");
